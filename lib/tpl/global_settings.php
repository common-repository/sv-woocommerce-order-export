				...
				<tr>
					...
					<td>
						<select name="settings[nested]">
							...
							<option value="data_flat"<?php echo ((isset($settings['settings']['nested']) && $settings['settings']['nested'] == 'data_flat') ? ' selected="selected"' : ''); ?>><?php echo __('flat', 'sv_woocommerce_order_export'); ?></option>
						</select>
					</td>
					<td>
						<ul>
							...
							<li><strong><?php echo __('flat', 'sv_woocommerce_order_export'); ?>:</strong> <?php echo __('Data for each order will be forced in same row, but some data may be stripped (e.g. when there is more than one item in a cart)', 'sv_woocommerce_order_export'); ?></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td><?php echo __('Force Additional Fields', 'sv_woocommerce_order_export'); ?></td>
					<td>
						<input name="settings[force_additional_fields]" type="text" value="<?php echo (isset($settings['settings']['force_additional_fields']) ? $settings['settings']['force_additional_fields'] : ''); ?>" />
					</td>
					<td>
						<p><?php echo __('Comma separated list of field-names.', 'sv_woocommerce_order_export'); ?></p>
						<p><?php echo __('If filter "Variations New Line" is active, you will need to insert the variation-fieldnames here.', 'sv_woocommerce_order_export'); ?></p>
					</td>
				</tr>
			</tbody>
		</table>
